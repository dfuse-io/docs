...
const redirectMap = {
  ...
  "/guides/getting-started/with-javascript/": ["/#get-started-dfuse-client-js"],
  "/guides/getting-started/with-python/": ["/#get-started-graphql-over-grpc-python"],
  "/guides/getting-started/with-go/": ["/#get-started-graphql-over-grpc-grpcurl"],
  "/guides/getting-started/with-other-languages/": ["/#get-started-other-languages"],
  ...
  "/guides/getting-started/more-examples/": ["/#get-started-tutorials"],
  ...
  "/reference/eosio/types/authtokenresponse": ["/#type-AuthTokenResponse"],
