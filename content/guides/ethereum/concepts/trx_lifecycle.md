...
{{< tab-code title="Graphql Query" filename="./tutorials/eth/lifecycle/src/query.graphql" range="1:111" opts="linenos=table">}}
{{< /tabs >}}
...
{{< tab-code title="Graphql Query" filename="./tutorials/eth/lifecycle/src/query.graphql" range="1:3" opts="linenos=table,hl_lines=3">}}
{{< /tabs >}}
...
{{< tab-code title="Graphql Query" filename="./tutorials/eth/lifecycle/src/query.graphql" range="1:5" delimeter="..." opts="linenos=table,hl_lines=4 5 6" >}}
{{< /tabs >}}
...
{{< tab-code title="Graphql Query" filename="./tutorials/eth/lifecycle/src/query.graphql" range="39:43" opts="linenos=table,hl_lines=4" >}}
{{< /tabs >}}

The fragment can de defined like this:

{{< tabs "trx-lifecycle-query-fields-transition-fragment-defined">}}
{{< tab-code title="Graphql Query" filename="./tutorials/eth/lifecycle/src/query.graphql" range="57:70" >}}
{{< /tabs >}}
