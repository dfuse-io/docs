...
{{< method-list-item name="linked_permissions" type="Array&lt;[LinkedPermission](#type-state-LinkedPermission)&gt;" required="true" >}}
...
{{< method-list-item name="contract" type="[AccountName](#type-AccountName)" required="true" >}}
  Contract's account on which the permission is applied.
{{< /method-list-item >}}

{{< method-list-item name="action" type="[ActionName](#type-ActionName)" required="true" >}}
  Action on which the permission is applied.
{{< /method-list-item >}}

{{< method-list-item name="permission_name" type="[PermissionName](#type-PermissionName)" required="true" >}}
