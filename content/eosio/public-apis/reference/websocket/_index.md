...
to use [GraphQL Subscription searchTransactionsForward]({{< ref "/eosio/reference/graphql#subscription-searchTransactionsForward" >}}) instead of `get_action_traces` and `get_table_rows`. Advantages of using the GraphQL API:
